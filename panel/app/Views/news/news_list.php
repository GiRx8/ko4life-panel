                                    ...
                                    <div>
                                        ...
                                        <table class="table" style="margin-left: 1em;">
                                            <tr style="border: transparent;">
                                                <th scope="col" style="color:gray; font-weight: bold;">ID</th>
                                                <th scope="col" style="color:gray; font-weight: bold;">Title</th>
                                                <th scope="col" style="color:gray; font-weight: bold;">Date</th>
                                                <th scope="col"><a class="btnpill" style="margin-left:3em" href="<?php echo base_url(); ?>/news/create">Create</a></th>
                                            </tr>
                                            <?php if (!empty($news) && is_array($news)) : ?>
                                                <?php foreach ($news as $news_item) : ?>
                                                    <?php echo "<tr>";
                                                    echo '<td scope="row" style="border: 0; color: gray;">' . $news_item['id'] . '</td>';
                                                    echo '<td style="border: 0; color: gray;">' . $news_item['title'] . '</td>';
                                                    echo '<td style="border: 0; color: gray;">' .  date('Y-m-d', strtotime($news_item['created_at']))  . '</td>';
                                                    echo '<td scope="col" style="border: 0; color: gray; margin-left:"><a class="btnpill" href="edit-view/' . $news_item['id'] . '">Edit | </a> <a class="btnpill" href="news/delete/' . $news_item['id'] . '">Delete</a></td>';
                                                    echo "</tr>"; ?>
                                                <?php endforeach ?>
                                            <?php else : ?>
                                            <?php endif ?>
