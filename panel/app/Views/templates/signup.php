				...
				<form action="#" method="post" name="login_form">
					<div class="left_columlogin">
						<div class="left_columloginsz">
							<div class="left_columloginpd"><input type="text" name="userid" size="14" maxlength="15" tabindex="1"><input type="password" name="pw" size="14" maxlength="16" tabindex="2">
							</div>
						</div>
						<div class="left_columloginbtn"><input type="image" src="images/login.png" alt="LOGIN" border="0" tabindex="3"></div>
					</div>
			...
			<div class="contenst_columpb">
				<div class="contentstop">
					<div class="contentstoppd">
						...
						<div class="pankz">
							<span><a href="<?php echo base_url(); ?>/">HOME></a></span><span><a href="<?php echo base_url(); ?>/forum">Community></a></span><span><a href="<?php echo base_url(); ?>/signup">Registration</a></span>
						</div>
						<!-- END TITLE BAR -->
					</div>
				</div>
				<div class="contentsmid">
					...
					<div class="contentsh2">
						<div class="contentsh2pd">
							<h2 style="margin-top: .43em; margin-left: 40%;">Registration</h2>
						</div>
					</div>
							...
							<div class="bbswidbgmid">
								<div class="bbsbbswidbgpd">
									...
									<div style="padding: 1px;">
										<table width="100%" height="135" border="0" cellpadding="2" cellspacing="2" class="news">
											<!-- News  start-->
											<div class="container-fluid mt-5">
												<div class="row justify-content-md-center" style="margin-top: 9em;">
													<div class="col-5">
														...
														<form action="<?php echo base_url(); ?>/signup/register" method="post">
															...
															<div class="d-grid">
																<button type="submit" style="padding: 5px; border-radius: 5px; background-color: #53493d; color: white; font-size: 18px;">Signup</button>
															</div>
														</form>
													</div>
												</div>
