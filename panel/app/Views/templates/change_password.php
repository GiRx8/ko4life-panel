								...
								<div class="bbsbbswidbgpd">
									<div style="padding: 1px;">
										...
										<div class="container-fluid mt-5 mb-5">
												<div class="row justify-content-md-center" style="padding: 2em;">
													<div class="col-5">
										...
										<?php endif; ?>
										<form action="<?php echo base_url('/signin/changepassword'); ?>" method="post">
											<?= csrf_field() ?>
											<div class="form-group">
												<label for="oldpassword">Old Password</label>
												<input class="form-control" name="oldpassword" id="oldpassword" type="password" style ="width: 15em;">
											</div>
											<div class="form-group">
												<label for="newpassword">New Password</label>
												<input class="form-control" name="newpassword" id="newpassword" type="password" style ="width: 15em;">
											</div>
											<div class="form-group">
												<label for="confirmpassword">Confirm Password</label>
												<input class="form-control" name="confirmpassword" id="confirmpassword" type="password" style ="width: 15em;">
											</div>
											<button class="btn mt-3" style="padding: 5px; margin-left: 33%; border-radius: 5px; background-color: #53493d; color: white; font-size: 12px;" type="submit">Update Password</button>
										</form>
													</div>
												</div>
										</div>
