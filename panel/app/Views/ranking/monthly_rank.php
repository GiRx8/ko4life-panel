		...
		<div id="contents_column">
			<div class="contenst_columpb">
				...
				<div class="contentsmid">
					...
					<div class="second">
						<div class="secondpd">
							<span class="selfin"><a href="<?php echo base_url(); ?>/ladder_rank">LADDER</a></span>
									...
									<div style="padding: 1px;">
										<table class="table" style="margin-left: 4em;">
											...
											<?php if (!empty($Urank) && is_array($Urank)) : ?>
												<?php foreach ($Urank as $Urank_item) : ?>
													<?php echo '<tr style="color: gray;">';
													echo "<td scope='row' style='border: 0; color: gray;'>" . $Urank_item['shIndex'] . "</td>";
													if ($Urank_item['shIndex'] == 1) {
														echo "<td style='border: 0; color: gray;'><img src='../images/s_0_20_0.gif'</td>";
													} elseif ($Urank_item['shIndex'] <= 4) {
														echo "<td style='border: 0; color: gray;'><img src='../images/s_0_21_0.gif'</td>";
													} elseif ($Urank_item['shIndex'] <= 9) {
														echo "<td style='border: 0; color: gray;'><img src='../images/s_0_22_0.gif'</td>";
													} elseif ($Urank_item['shIndex'] <= 25) {
														echo "<td style='border: 0; color: gray;'><img src='../images/s_0_23_0.gif'</td>";
													} elseif ($Urank_item['shIndex'] <= 50) {
														echo "<td style='border: 0; color: gray;'><img src='../images/s_0_24_0.gif'</td>";
													} elseif ($Urank_item['shIndex'] <= 100) {
														echo "<td style='border: 0; color: gray;'><img src='../images/s_0_25_0.gif'</td>";
													}
													echo "<th style='border: 0; color: gray;'>" . $Urank_item['strElmoUserID'] . "</th>";
													echo "<th style='border: 0; color: gray;'>" . $Urank_item['nElmoLoyalty'] . "</th>";
													echo "</tr>"; ?>
												<?php endforeach ?>
											<?php else : ?>
											<?php endif ?>
